"""Shared trailing momentum calculation for skip-month variants."""
...
class TrailingMomentumEntrySignal(BaseEntrySignal):
    """Adjusted-price return over lookback_days ending skip_days before evaluation."""
